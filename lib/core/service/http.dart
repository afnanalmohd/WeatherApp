...
class Http {
  ...
  Future<https.Response> getRequest({
    ...
    return await _client.get(
      ...
      // i am putting the base url here to run the app automatic with out need to env
      Uri.parse('http://api.weatherstack.com/$endpoint'),
      headers: headers,
    );
  }
  ...
  Future<https.Response> postRequestWithToken(
    ...
    return await _clientWithToken.post(Uri.parse('$baseUrl/$endpoint'),
